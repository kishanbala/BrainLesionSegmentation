...
img_dir = 'E/CMB/nii'
out_dir = '/Volumes/Seagate Backup Plus Drive/Dataset-CMB/cmb-3dcnn-data/3d_Patches'
x_shape = 16
y_shape = 16
z_shape = 10
...
def main():
    ...
    for fn in fns:
        ...
        image_1 = itk.imread(input_filename, PixelType)
        #smoothed = itk.median_image_filter(image_1, ttype=(ImageType, ImageType))
